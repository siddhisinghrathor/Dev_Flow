                                    ...
                                    <Card className={cn(
                                        ...
                                        task.priority === 'high' ? "bg-zinc-950 dark:bg-zinc-900 text-white" :
                                            task.priority === 'medium' ? "bg-gradient-to-br from-primary-600 to-indigo-700 text-white" :
                                                "bg-card text-card-foreground border border-accent/20"
                                    )}>
                                        ...
                                        <CardContent className="p-8 flex flex-col h-full justify-between relative">
                                            <div className="space-y-4">
                                                <div className="flex items-center gap-3">
                                                    <div className={cn(
                                                        "p-2 rounded-xl",
                                                        task.priority === 'low' ? "bg-accent/50 text-primary-600" : "bg-white/10 text-white"
                                                    )}>
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div className={cn(
                                                    ...
                                                    task.priority === 'low' ? "border-accent bg-accent/30 text-primary-600" : "border-white/20 bg-white/10 text-white"
                                                )}>
